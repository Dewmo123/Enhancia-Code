...
namespace _00.Work.CIW._01.Scripts.Enemy
{
    public class Ghoul : BTEnemy
    {
        ...
        private void Start()
        {
            BlackboardVariable<StateChangeEvent> stateChannelVariable = GetBlackboardVariable<StateChangeEvent>("StateChannel"); // 왜 Null 뜨지
            ...
            Debug.Assert(_stateChannel != null, $"state channel is null in {gameObject.name}");
        ...
        protected override void HandleHit()
        {
            ...
            _state.Value = BTEnemyState.HIT; // Hit으로 못 가
